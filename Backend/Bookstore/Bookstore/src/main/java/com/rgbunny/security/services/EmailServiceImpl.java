...
public class EmailServiceImpl {
    ...
    private String buildEmailContent(String resetLink) {
        return "<a style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>"
                ...
                + "<p><a href='" + resetLink + "' style='background-color: #4299e1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; display: inline-block;'>Reset Password</a></p>"
