...
import com.rgbunny.dao.AddressRepository;
...
public class AddressServiceImpl implements AddressService{
    ...
    public AddressDTO updateAddress(Long addressId ,AddressUpdateRequest addressUpdateRequest, User user) {
        Address address = addressRepository.findById(addressId).orElseThrow(()-> new ResourceNotFoundException("Address's not found"));
